...
local __ohmyzsh_theme__user_color=145
local __ohmyzsh_theme__dir_color=145
case $CONTAINER_ID in 

    ubuntu)
        local __ohmyzsh_theme__user_color=100
        local __ohmyzsh_theme__dir_color=100
        ;;
    fedora)
        local __ohmyzsh_theme__user_color=111
        local __ohmyzsh_theme__dir_color=111
        ;;
    *)
        local __ohmyzsh_theme__user_color=145
        local __ohmyzsh_theme__dir_color=145
...
local user='%B$FG[${__ohmyzsh_theme__user_color}]%}%n@$CONTAINER_ID@%m%{$reset_color%}'
